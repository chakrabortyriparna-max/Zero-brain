...
- **fail** if ANY of: governance modified, critical/high issue, unjustified new deps, unknown-source packages, secret detected, or hard invariants (rate-limit, auth, core config) per CLAUDE.md are touched.
